...
const headers = {
  ...
  'Origin': 'https://65373d6e95c3170001074c57.caiyicloud.com',
  'Referer': 'https://65373d6e95c3170001074c57.caiyicloud.com/package-user/pages/audience-modification/audience-modification?watcherReplacer=%E8%A7%82%E6%BC%94',
...
async function addAddress() {
    ...
    return fetch('https://65373d6e95c3170001074c57.caiyicloud.com/cyy_gatewayapi/user/buyer/v3/user/addresses', {
        method: 'POST',
        headers: {
            ...headers
        },
...
function getAddress() {
    return fetch('https://65373d6e95c3170001074c57.caiyicloud.com/cyy_gatewayapi/user/buyer/v3/user/addresses?src=WEB&ver=4.10.1', {
        headers: {
        ...headers
        }
    }).then(res => res.json())
